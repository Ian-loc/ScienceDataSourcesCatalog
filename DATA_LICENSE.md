# Licença dos dados do catálogo

A seleção, descrição e organização originais deste catálogo são disponibilizadas sob Creative Commons Atribuição 4.0 Internacional (CC BY 4.0).
